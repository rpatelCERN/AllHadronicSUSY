...
from AllHadronicSUSY.RA2TreeMaker.makeRA2TreeFromMiniAOD_cff import makeRA2TreeTreeFromMiniADO
makeRA2TreeTreeFromMiniADO(process,
                outFileName="RA2ReducedSelection",
                NJetsMin=nJetsMin,
                HTMin=htMin,
                MHTMin=mhtMin,
                reportEveryEvt=5000,
